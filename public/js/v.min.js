! function(a, b) {
    ...
    function w(a, b, c) {
        if (m.isFunction(b))
            return m.grep(a, function(a, d) { return !!b.call(a, d, a) !== c });
        if (b.nodeType)
            return m.grep(a, function(a) { return a === b !== c });
        if ("string" == typeof b) {
            if (v.test(b))
            ...
            focus: {
                trigger: function() {
                    if (this !== cb() && this.focus)
                        try { return this.focus(), !1 } catch (a) {}
                },
                delegateType: "focusin"
            },
            blur: { trigger: function() { return this === cb() && this.blur ? (this.blur(), !1) : void 0 }, delegateType: "focusout" },
            click: { trigger: function() { return m.nodeName(this, "input") && "checkbox" === this.type && this.click ? (this.click(), !1) : void 0 }, _default: function(a) { return m.nodeName(a.target, "a") } },
    ...
    var sc = /^(?:input|select|textarea|button|object)$/i,
        tc = /^(?:a|area)$/i;
    m.fn.extend({ prop: function(a, b) { return V(this, m.prop, a, b, arguments.length > 1) }, removeProp: function(a) { return a = m.propFix[a] || a, this.each(function() { try { this[a] = void 0, delete this[a] } catch (b) {} }) } }), m.extend({
    ...
    m.fn.extend({
        addClass: function(a) {
            var b, c, d, e, f, g, h = 0,
                ...
                j = "string" == typeof a && a;
            if (m.isFunction(a))
                return this.each(function(b) { m(this).addClass(a.call(this, b, this.className)) });
            if (j)
        ...
        removeClass: function(a) {
            ...
            if (m.isFunction(a))
                return this.each(function(b) { m(this).removeClass(a.call(this, b, this.className)) });
            if (j)
                for (b = (a || "").match(E) || []; i > h; h++)
                    if (c = this[h], d = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(uc, " ") : "")) {
                        f = 0;
    ...
    m.extend({
        ...
        wrapAll: function(a) {
            if (m.isFunction(a))
                return this.each(function(b) { m(this).wrapAll(a.call(this, b)) });
            if (this[0]) {
    ...
    m.offset = {
        ...
        offset: function(a) {
            if (arguments.length)
                return void 0 === a ? this : this.each(function(b) { m.offset.setOffset(this, a, b) });
...
if ("undefined" == typeof jQuery)
    ...
    }, c.prototype.getUID = function(a) { do { a += ~~(1e6 * Math.random()) } while (document.getElementById(a)); return a }, c.prototype.tip = function() {
...
! function(a) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], a) : "undefined" != typeof exports ? module.exports = a(require("jquery")) : a(jQuery) }(function(a) {
    ...
    b = function() {
        ...
        if ("object" === a.type(arguments[0]) ? (e = arguments[0], g = arguments[1], h = "multiple") : "string" === a.type(arguments[0]) && (e = arguments[0], f = arguments[1], g = arguments[2], "responsive" === arguments[0] && "array" === a.type(arguments[1]) ? h = "responsive" : "undefined" != typeof arguments[1] && (h = "single")), "single" === h)
            ...
            a.each(e, function(a, c) { b.options[a] = c });
...
(function($, undefined) {
    $.fn.jRate = function(options) {
        "use strict";
        var $jRate = $(this);
        var defaults = { rating: 0, shape: "STAR", count: 5, width: "20", height: "20", widthGrowth: 0, heightGrowth: 0, backgroundColor: "white", startColor: "yellow", endColor: "green", strokeColor: "black", transparency: 1, shapeGap: "0px", opacity: 1, min: 0, max: 5, precision: .1, minSelected: 0, strokeWidth: "2px", horizontal: !0, reverse: !1, readOnly: !1, touch: !0, onChange: null, onSet: null };
        var settings = $.extend({}, defaults, options);
        var startColorCoords, endColorCoords, shapes;

        function isDefined(name) { return typeof name !== "undefined" }
        ...
        function showRating(rating) {
            ...
            if (settings.reverse) {
                for (var i = 0; i < rating; i++) {
                    ...
                    if (isDefined(endColorCoords)) { fillColor = formulateNewColor(settings.count - 1, i) }
                }
            } else {
                for (var i = 0; i < rating; i++) {
        ...
        var formulateNewColor = function(totalCount, currentVal) {
            ...
            for (var i = 0; i < 3; i++) {
                ...
                else avgFill[i] = (startColorCoords[i] + diff * (currentVal + 1)) % 256
            }
        ...
        function onEnterOrClickEvent(e, ith, label, update) {
            ...
            var partial;
            if (settings.horizontal) { partial = (e.pageX - svg.offset().left) / svg.width() } else { partial = (e.pageY - svg.offset().top) / svg.height() }
            ...
            if (rating < settings.minSelected)
                rating = settings.minSelected;
        ...
        function drawShape() {
            var svg, i, sw, sh;
            for (i = 0; i < settings.count; i++) { $jRate.append(getShape(i + 1)) }
            shapes = $jRate.find("svg");
            for (i = 0; i < settings.count; i++) {
                svg = shapes.eq(i);
                bindEvents(svg, i + 1);
                if (!settings.horizontal) { svg.css({ display: "block", "margin-bottom": settings.shapeGap || "0px" }) } else { svg.css("margin-right", settings.shapeGap || "0px") }
                if (settings.widthGrowth) {
                    sw = "scaleX(" + (1 + settings.widthGrowth * i) + ")";
                    svg.css({ transform: sw, "-webkit-transform": sw, "-moz-transform": sw, "-ms-transform": sw, "-o-transform": sw })
                }
                if (settings.heightGrowth) {
                    sh = "scaleY(" + (1 + settings.heightGrowth * i) + ")";
                    svg.css({ transform: sh, "-webkit-transform": sh, "-moz-transform": sh, "-ms-transform": sh, "-o-transform": sh })
                }
            }
            showNormalRating();
            showRating(settings.rating);
        ...
        setCSS();
        drawShape();
        return $.extend({}, this, { getRating: getRating, setRating: setRating, setReadOnly: function(flag) { settings.readOnly = flag }, isReadOnly: function() { return settings.readOnly } })
    }
})(jQuery);
...
(function($) { $.fn.init_scollbar_inset_dark = function() { $(this).mCustomScrollbar({ theme: "inset-2-dark", mouseWheelPixels: 250 }) } })(jQuery);
(function(document, window, $) {
    $(document).ready(function() { $(".top-slider").slick({ arrows: !1, slidesToShow: 1, slidesToScroll: 1, dots: !0, infinite: !0, autoplay: !0, autoplaySpeed: 5e3, speed: 1e3, responsive: [{ breakpoint: 480, settings: { arrows: !1 } }] }) });
    $(document).ready(function() { $(".phimdecu-slider").slick({ arrows: !0, autoplay: !0, slidesToShow: 5, slidesToScroll: 5, dots: !1, infinite: !0, autoplaySpeed: 5e3, speed: 600, responsive: [{ breakpoint: 992, settings: { slidesToShow: 4, slidesToScroll: 4, infinite: !0 } }, { breakpoint: 768, settings: { slidesToShow: 3, slidesToScroll: 3, infinite: !0 } }, { breakpoint: 375, settings: { slidesToShow: 2, slidesToScroll: 2, infinite: !0 } }] }) });
    $(document).ready(function() { var navpos = $(".navbar-default").offset() });

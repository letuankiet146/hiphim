  ...
  <table class="table"  id="myTable">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td></td>
            <td><a title="Go to Fix" data-toggle="modal" data-target="#myModal" class="btn btn-danger " href="/updatelink/{{$phim->id}}">Go to fix</a>
            <a title="Add server" data-toggle="modal" data-target="#myModal" class="btn btn-info " href="/addserver/{{$phim->id}}">Servers</a></td>
